...
})({"cR7wX":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "69f74e7f31319ffd";
module.bundle.HMR_BUNDLE_ID = "694c7ffd4a4da669";
"use strict";
...
},{}],"9EkL6":[function(require,module,exports) {
...
window.setup = ()=>{
    ...
    if (window.innerWidth > 600) startingPoints = font.textToPoints(string, width / 2, height / 2 + offsetY, size, {
        sampleFactor: fontSampleFactor
    });
    else for(let index = 0; index < 1000; index++)startingPoints.push({
        x: random(0, width),
        y: random(0, height)
    });
...
window.draw = ()=>{
    ...
    for(let pt = points.length - 1; pt >= 0; pt--){
        ...
        p.x = newPX;
        p.y = newPY;
        if (random() > particlePersist) p.isMoving = false;
        if (!p.isMoving || p.x > width || p.x < 0 || p.y < 0 || p.y > height) points.splice(pt, 1);
...
},{}]},["cR7wX","9EkL6"], "9EkL6", "parcelRequire2041")

//# sourceMappingURL=index.4a4da669.js.map
